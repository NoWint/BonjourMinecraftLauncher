...
import { X, AlertTriangle, FileText, ChevronRight, ChevronDown, Bug, Cpu, Monitor, MemoryStick, Wrench } from 'lucide-react'
...
export default function CrashReportViewer({ onClose, initialReport }: CrashReportViewerProps) {
  ...
  useEffect(() => {
    window.minecraftAPI?.getCrashReports?.(20).then((r) => {
      setReports(r as CrashReport[])
                  ...
                  <div className="rounded-xl border border-red-500/20 bg-red-500/5 p-4 space-y-3">
                    ...
                    {selectedReport.diagnosis.solutions.length > 0 && (
                      <div className="space-y-2 pt-2 border-t border-white/5">
                        ...
                        {selectedReport.diagnosis.solutions.map((sol, _i) => (
