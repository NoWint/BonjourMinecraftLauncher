...
import { X, Package, FileArchive, CheckCircle, AlertCircle } from 'lucide-react'
...
export default function ModpackInstaller({ onClose, onInstalled }: ModpackInstallerProps) {
  ...
  const handleInstall = async () => {
    ...
    try {
      const res = await window.minecraftAPI?.installModpack(filePath, instanceName || undefined) as unknown as ModpackInstallResult
