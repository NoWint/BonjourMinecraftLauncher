...
import type { ThemeId } from '../theme/useThemeStore'
...
export interface ThemeContextValue {
  ...
  activeDualTheme: ThemeId
  switchDualTheme: (t: ThemeId) => void
}
...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  const dualTheme = useThemeStore((s) => s.activeTheme)
  const switchDualTheme = useThemeStore((s) => s.switchTheme)
  const initDualTheme = useThemeStore((s) => s.init)
  ...
  const value = useMemo(() => ({
    ...
    switchDualTheme,
  }), [theme, resolvedTheme, setTheme, toggleTheme, currentPreset, setPreset, allPresets, customAccent, setCustomAccent, isCustom, createCustomPreset, deleteCustomPreset, exportTheme, importTheme, transition, setTransition, isTransitioning, dualTheme, switchDualTheme])
