    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          ...
          <h3 className="text-xl font-bold text-white mb-2">还没有安装任何版本</h3>
          <p className="text-white/40 mb-6">切换到「浏览版本」来安装你的第一个 Minecraft</p>
        </div>
      </div>
    )
  }
    ...
    <div className="space-y-2">
      ...
      {filteredVersions.length === 0 && (
        <div className="text-center py-12">
          ...
          <p className="text-white/30">没有找到匹配的版本</p>
        </div>
      )}
    </div>
  )
